...
while True:
    ...
    sport_messages = [
        Message(str(i), belongs_to_category=True) for i in sports]
    for i in politics:
        sport_messages.append(Message(str(i), belongs_to_category=False))
    for i in economy:
        sport_messages.append(Message(str(i), belongs_to_category=False))
    for i in health:
        sport_messages.append(Message(str(i), belongs_to_category=False))
    ...
    politics_messages = [
        Message(str(i), belongs_to_category=True) for i in politics]
    for i in sports:
        politics_messages.append(Message(str(i), belongs_to_category=False))
    for i in economy:
        politics_messages.append(Message(str(i), belongs_to_category=False))
    for i in health:
        politics_messages.append(Message(str(i), belongs_to_category=False))
    ...
    economy_messages = [
        Message(str(i), belongs_to_category=True) for i in economy]
    for i in politics:
        economy_messages.append(Message(str(i), belongs_to_category=False))
    for i in sports:
        economy_messages.append(Message(str(i), belongs_to_category=False))
    for i in health:
        economy_messages.append(Message(str(i), belongs_to_category=False))
    ...
    health_messages = [
        Message(str(i), belongs_to_category=True) for i in health]
    for i in sports:
        health_messages.append(Message(str(i), belongs_to_category=False))
    for i in economy:
        health_messages.append(Message(str(i), belongs_to_category=False))
    for i in politics:
        health_messages.append(Message(str(i), belongs_to_category=False))
